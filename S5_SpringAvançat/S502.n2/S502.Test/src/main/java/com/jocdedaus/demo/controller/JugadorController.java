...
public class JugadorController {
    ...
    @GetMapping(value = "{jugadorId}/name")
    public ResponseEntity<String> getJugadorName(@PathVariable final int jugadorId) {
        String jugadorName = jugadorService.getJugadorName(jugadorId);
        return new ResponseEntity<>(jugadorName, HttpStatus.OK);
    }
